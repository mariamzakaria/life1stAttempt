...
function ShopPageDesign (props) {
    ...
    return(
          ...
          <Card key={props.product.id}>
            ...
            <Card.Body>
              <Card.Title dir="rtl"className="card-title">{props.product.name} </Card.Title>{/*<span>{this.props.product.quantity} </span> */}
             {/* <Card.Text dir="rtl">Price: {props.product.price}$</Card.Text>*/}
